...
class CourtReference:
    ...
    def __init__(self):
        x=0
        y=0
        self.baseline_top = ((0, 0), (6100, 0))
        self.baseline_bottom = ((0, 13400), (6100, 13400))
        self.net = ((0, 6700), (6100, 6700))
        self.left_court_line = ((0, 0), (0, 13400))
        self.right_court_line = ((6100, 0), (6100, 13400))
        self.left_inner_line = ((460, 0), (460, 13400))
        self.right_inner_line = ((6100-500, 0), (6100-500, 13400))
        self.middle_line = ((500+2530, 0), (500+2530, 0))
        self.top_inner_line = ((0, 760), (6100, 760))
        self.bottom_inner_line = ((0, 13400-760), (6100, 13400-760))
        self.top_extra_part = (500+2530, 0)
        self.bottom_extra_part = (500+2530, 13400)
        ...
        self.line_width = 40
        self.court_width = 6100
        self.court_height = 13400
        self.top_bottom_border = x
        self.right_left_border = y
